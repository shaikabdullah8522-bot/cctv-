...
SQLite Database Setup & Table Definitions
=============================================================================
Module: database.py
...
def seed_default_data(db_path=DB_PATH):
    """
    Seeds default administrative users, timetable periods, student records,
...
if __name__ == "__main__":
    print("=" * 70)
    print("AI-Based CCTV Attendance System - Database Setup")
    print("=" * 70)
